rownames(raw_counts) = t2g$name[match(rownames(raw_counts), t2g$Gene)]
...
dds <- DESeqDataSetFromMatrix(countData = raw_counts,
                              colData = meta,
                              design = ~1)
# CDC15 Does not have a YPD sample! if you want to use it you gotta change the reference. or just use the interactions without the base (~Strain:Condition)
