...
yeastnet = read_delim('input//Downloads/YeastNet.v3.txt', delim = '\t', col_names = c('Gene_1', 'Gene_2', 'weight'))
...
p_est = pickSoftThreshold.fromSimilarity(similarity = adj_inv_logit)
TOM = TOMsimilarity(adjMat = adj_inv_logit^p_est$estimate)
dissTOM = 1-TOM
