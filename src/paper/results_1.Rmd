...
Genes with no variability will be problematic in downstream analysis. As we can infer very little about these genes, it is apprpriate to filter them out. We will arbitrarily filter out genes whos dynamic range is less than 1 in all the samples. as well as genes that have a low level of counts (Mean expression < 2^6 == 64 Counts)
