...
Kinases are largely responsible for mediating environmental information to the nucleus where an adaptive transcriptional response can be made. The propogation of this information occurs through a pathways of cascading phosporylation events. Here we use strains with analog sensisitive mutatants of certain stress associated kinases to block kinase signalling while under a variety of stress. The resulting change in gene expression is then measured using RNA-seq and analyzed.
