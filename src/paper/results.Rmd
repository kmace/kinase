...
We collect 300 whole genome gene expression measurements, each with one of 10 conditions, and one of 28 kinases inhibited. Here, we cluster the samples by performing t-SNE on gene expression vectors with default t-SNE parameters
